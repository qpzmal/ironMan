package com.fighttiger.fighter.common.tools.md5;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import com.fighttiger.fighter.common.tools.ImportExcelUtil;
...
public class StrMD5 {
	 ...
	 * @throws Exception 
	 */
	public String signature(Object... args) throws Exception {
		String signtext = "";
	...
	public String signWithCharset(String charset, Object... args) throws Exception {
		String signtext = "";
		for (int i = 0; i < args.length; i++) {
			signtext += null == args[i] ? "" : args[i];
		}
	 ...
	 * @throws Exception 
	 */
	public String encrypt(String pwd, String salt) throws Exception {
	...
	public String getMD5Str(String key, String charset) throws Exception {
		try {
			MessageDigest currentAlgorithm = MessageDigest.getInstance("MD5");
